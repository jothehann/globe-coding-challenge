...
export class StatusPage extends BasePage {
    ...
    constructor(page: Page) {
        super(page);
        this.lblOrderIsConfirmed = page.getByRole('heading', { name: 'Your order is confirmed!' });
    ...
    async verifyOrder(user: UserType) {
        // Verify Thanks
        const lblThanks = this.page.getByRole('heading', { name: `Thanks ${user.firstName} for your order!` })
