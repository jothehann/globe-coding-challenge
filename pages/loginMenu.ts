...
export class LoginMenu extends BasePage{
    ...
    constructor(page: Page) {
        ...
        this.txtBoxEmail = page.getByRole('textbox', { name: 'Email', exact: true });
        this.txtBoxPassword = page.getByRole('textbox', { name: 'Password', exact: true });
        this.txtBoxPasswordConfirmation = page.getByRole('textbox', { name: 'Password Confirmation' });
